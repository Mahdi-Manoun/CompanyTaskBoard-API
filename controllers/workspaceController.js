...
const deleteWorkspace = async (req, res) => {
    try {
        ...
        res.status(200).json({ message: `${workspace.title} deleted successfully` })
    } catch (error) {
        res.status(500).json({ error: 'Server Error' })
    }
}
...
const updateWorkspace = async (req, res) => {
    try {
        ...
        res.status(200).json({ message: `Workspace updated successfully to ${newTitle}` })
    } catch (error) {
        res.status(500).json({ error: 'Server Error' })
    }
}
...
const assignUserIdToCard = async (req, res) => {
    try {
